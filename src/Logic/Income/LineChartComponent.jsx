    ...
    <div style={{ width: "95%", height: 320 }} className="mt-12">
      <ResponsiveContainer>
        <LineChart data={data} margin={{left:30,bottom:10}} >
          ...
          <YAxis dataKey="income" axisLine={false} tickLine={false} tick={{fontSize:14,fontWeight:600,fill:'#000000'}} tickFormatter={(value) => `₹${value}`} tickMargin={15} />
          <Tooltip />
          <Line type="monotone" dataKey="income" name="Income" stroke="#7c3aed" />
        </LineChart>
      </ResponsiveContainer>
    </div>
