...
const Login = () => {
 ...
 const SubmitForm = async (data) =>{
   ...
   const googleLogin = () =>{
     ...
     window.location = "https://expense-latest-1.onrender.com/oauth2/authorization/google"
   }

   const githubLogin = () =>{

         window.location = "https://expense-latest-1.onrender.com/oauth2/authorization/github"
